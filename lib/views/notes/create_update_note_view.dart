...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  Future<CloudNote> createOrCreateExistingNote(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          IconButton(
            onPressed: () async {
              ...
              if (_note == null || text.isEmpty) {
                await showCannotShareEpmtyNoteDialog(context);
              } else {
                Share.share(text);
              }
            },
      ...
      body: FutureBuilder(
          future: createOrCreateExistingNote(context),
